...
export const HomePage = () => {
    return (
        ...
        >
            ...
            >
                Join approximately more than 60 million students who use Flip
                Quiz flashcards, exam prep, and professional solutions to
                enhance their GPAs and accomplish their objectives.
            </Typography>
            <Button
                color="primary"
                variant="contained"
